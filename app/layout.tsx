      ...
      <body className={inter.className}>
        <div className="bg-orange py-2 text-white">
          <div className="container mx-auto flex justify-center">
            <p className="text-xs"><a target="_blank" href="https://wa.me/+233256630005" className="font-black">Report Violations at Whatsapp Hotline: <span className="font-black">+ 233 256630005</span></a></p>
          </div>
        </div>
        {children}
        <Footer />
