      ...
      <div className="max-lg:bg-[url('/img/bg-video-small.svg')] bg-mainBlue lg:h-full h-96 w-full bg-no-repeat bg-cover bg-center lg:rounded-b-[4rem] lg:pb-10">
        ...
        <div>
          <div className="flex justify-center my-10">
            <div className="lg:bg-[url('/img/bg-video.svg')] bg-none h-full w-full bg-no-repeat bg-contain bg-center flex justify-center items-center">
              <Dialog>
          ...
          <div className='lg:block hidden'>
            ...
            >
              ...
              <div className="bg-white mb-5 mx-5 py-16 rounded-xl space-y-6 transition duration-300 p-5">
                <div className="bg-gray-200 text-orange rounded-full flex items-center justify-center h-12 w-12 my-5 ">
